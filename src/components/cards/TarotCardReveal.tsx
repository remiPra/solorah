...
const texts: Record<string, { reversed: string; readingTitle: string; cta: string; newReading: string; share: string }> = {
  fr: {
    ...
    cta: 'Consultation personnalisée',
  ...
  return (
    <div className="min-h-[100vh] px-4 py-16 -mt-16">
      <div className="max-w-4xl mx-auto">
        ...
        {/* Interpretation section — appears after all 3 cards flipped */}
        {revealStep >= 4 && (
          <motion.div
...
function SingleCardFlip({ selected, lang, isRevealed, index }: SingleCardFlipProps) {
  ...
  useEffect(() => {
    ...
    // Restore ambient audio after flip completes
      ...
      >
        ...
        <motion.div
          ...
          style={{
            ...
            height: 'clamp(150px, 37.5vw, 270px)',
          }}
          className="relative"
        >
          {/* Back face */}
